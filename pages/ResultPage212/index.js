...
const ResultPage = ({backgroundColor, margin}) => {
    ...
    return <div style={{backgroundColor}} className="resultpage" >
        ...
        <ResultCard answer1="3-5 Hours" answer2="None" answer3="5-6 Hours"  />
        </div>
        <Results advice1="You sit a decent amount, but to improve try scraping another hour of sitting away and do some cardio exercises" advice2="A minimum of 400g of fruit and veg should be eaten every day" advice3="Try getting a couple more hours of sleep, you'll feel more energized during the day." result="You sit a decent amount and get a decent amount of sleep, however, you are not eating healthy enough " />
