export const image = {
    couchpotatoImg = require('./couchpotato.svg'),
    effortneededImg = require('./effortneeded.svg'),
    healthypersonImg = require('./healthyperson.svg')
}
...
//effort needed start
    ...
    else if(data.resultsit === "3-5 Hours" && data.resulteat === "2 Cup" && data.resultsleep === "5-6 Hours"){
        data.type = "Effort Needed";
