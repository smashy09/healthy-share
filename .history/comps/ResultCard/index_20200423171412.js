...
const ResultCard = ({header, question1, question2, question3, backgroundColor, margin}) => <div
className="result_card" style={{backgroundColor:backgroundColor, margin:margin}}> 
