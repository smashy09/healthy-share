...
var result_state1 = {
  ...
  function Survey1Update1() {
    document.querySelector("#result_status1").innerText = result_state1.items[0].title;
    // document.querySelector(".item_circ1").innerText = item_state.items[0].num;
  }

  function Survey1Update2() {
    document.querySelector("#result_status1").innerText = result_state1.items[1].title;
    // document.querySelector(".item_circ1").innerText = item_state.items[0].num;
  }

  function Survey1Update3() {
    document.querySelector("#result_status1").innerText = result_state1.items[2].title;
    // document.querySelector(".item_circ1").innerText = item_state.items[0].num;
  }

  function Survey2Update1() {
    document.querySelector("#result_status2").innerText = result_state2.items[0].title;
    // document.querySelector(".item_circ1").innerText = item_state.items[0].num;
  }

  function Survey2Update2() {
    document.querySelector("#result_status2").innerText = result_state2.items[1].title;
    // document.querySelector(".item_circ1").innerText = item_state.items[0].num;
  }

  function Survey2Update3() {
    document.querySelector("#result_status2").innerText = result_state2.items[2].title;
    // document.querySelector(".item_circ1").innerText = item_state.items[0].num;
  }

  function Survey3Update1() {
    document.querySelector("#result_status3").innerText = result_state3.items[0].title;
    // document.querySelector(".item_circ1").innerText = item_state.items[0].num;
  }

  function Survey3Update2() {
    document.querySelector("#result_status3").innerText = result_state3.items[1].title;
    // document.querySelector(".item_circ1").innerText = item_state.items[0].num;
  }

  function Survey3Update3() {
    document.querySelector("#result_status3").innerText = result_state3.items[2].title;
    // document.querySelector(".item_circ1").innerText = item_state.items[0].num;
  }
