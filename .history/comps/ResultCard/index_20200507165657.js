...
className="result_card" style={{backgroundColor:backgroundColor}}> 
        ...
        <div className="ResultCardContainer">
            <div className="ResultCard">
                <div style={{fontSize:"19px"}} className="card_question" id="card_question1">
                    {question1}
                </div>
            ...
            <div className="ResultCard" >
                <div style={{fontSize:"19px"}} className="card_question" id="card_question2">
                    {question2}
                </div>
                <div style={{fontSize:"22px"}} className="card_answer">
                    {answer2}
            ...
            <div className="ResultCard">
                <div style={{fontSize:"19px"}} className="card_question" id="card_question3">
                    {question3}
                </div>
                <div style={{fontSize:"22px"}}className="card_answer">
                     {answer3}
