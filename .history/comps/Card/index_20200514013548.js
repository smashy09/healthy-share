...
const Card = ({ColorChange1, ColorChange2, ColorChange3, header, question, backgroundColor, optionbackgroundColor, healthytxt, balancedtxt, unhealthytxt, healthyImg, balancedImg, unhealthyImg, onClick}) => <div
...
className="survey_card"> 
    ...
    <div className="card_answers">
        <div className="options1" onClick={ColorChange1} style={{backgroundColor:optionbackgroundColor}} >
            <img src={unhealthyImg} />
            {unhealthytxt} 
        </div>

        <div className="options2" style={{backgroundColor:optionbackgroundColor}} >
           <img src={balancedImg} onClick={ColorChange2} />
            {balancedtxt}
         </div>

        <div className="options3" style={{backgroundColor:optionbackgroundColor}} >
           <img src={healthyImg} onClick={ColorChange3} />
            {healthytxt} 
