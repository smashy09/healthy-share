...
className="survey_card"> 
    ...
    <div className="card_answers">
        <div className="options1" onClick={Option1} style={{backgroundColor:data.colorchange}} >
            <img src={unhealthyImg} />
            {unhealthytxt} 
        </div>

        <div className="options2" style={{backgroundColor:data.colorchange}} >
           <img src={balancedImg} onClick={Option2} />
            {balancedtxt}
         </div>

        <div className="options3" style={{backgroundColor:data.colorchange}} >
