...
<div id="All_home_page">
    <CustomText fontSize={72} color="#A2C5AC" text="Healthy-U"/>
<img src={img} className="image"/>
<CustomText fontSize={32}  text="Become a better U today!"/>
<div className="start_button">
<CustomButton text="Start App!"  onClick={NextPage}/>
</div>
<CustomText fontSize={22} color="A2C5AC" text="This app will give you the information you need to become a healthier U!"/>
</div>
</div>
